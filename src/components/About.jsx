...
const About = () => {
  return (
    <>
      ...
      >
        Motivated and dedicated entry-level engineer, seeking to apply my expertise in Front-end Development to add value
to a dynamic team. With a solid foundation in HTML, Cascading Style Sheets (CSS), Bootstrap , WordPress, and
